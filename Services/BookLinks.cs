...
namespace Services
{
    public class BookLinks : IBookLinks
    {
        ...
        public LinkResponse TryGenerateLinks(IEnumerable<BookDto> booksDto, string fields, HttpContext httpContext)
        {
            ...
            return ShapedBooks(shapedBooks);
        }
        ...
        private LinkCollectionWrapper<Entity> CreateForBooks(HttpContext httpContent, LinkCollectionWrapper<Entity> bookCollectionWrapper)
        {
        ...
        private LinkResponse ShapedBooks(List<Entity> shapedBooks)
        {
